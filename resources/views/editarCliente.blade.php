...
@endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="adress" value="{{$c->adress}}"
                                        class="form-control" 
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="city"> Cidade </label>
                                     <input type="text" id="city" value="{{$c->city}}"
                                            class="form-control" 
                            ...
                            <div class="col col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="state" value="{{$c->state}}"
                                            class="form-control" 
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cpf" value="{{$c->cpf}}"
...
@endif
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" value="{{$c->phone}}"
...
@endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="email" value="{{$c->email}}"
